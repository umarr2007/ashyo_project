        ...
        <div className="container max-w-[1440px] mx-auto">
          <div className="wrapper flex justify-between items-center">
              ...
              {showCategories && (
                <div className="absolute top-[55px] left-0 z-10 bg-white border border-[#e1e8f0] rounded-md shadow-lg p-4 w-[200px] max-h-[300px] overflow-y-auto">
                  {categories.map((category) => (
                    <p className="text-[14px]  text-[#545d6a] font-medium py-2 px-4 hover:bg-[#f0f4f8] cursor-pointer rounded-md transition-all duration-200">
                      {category.name}
                    </p>
                  ))}
                </div>
            ...
            <div className="inputs flex">
              <input
                className="rounded-[6px] border-none w-[518px] h-[48px] p-4 bg-[#ebeff3] font-normal text-[13px] text-[rgba(0,_0,_0,_0.2)]"
